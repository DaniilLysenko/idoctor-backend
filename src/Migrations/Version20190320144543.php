 ...
 */
final class Version20190320144543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hospital ADD createdAt DATETIME NOT NULL, ADD updatedAt DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hospital DROP createdAt, DROP updatedAt');
    }
}
